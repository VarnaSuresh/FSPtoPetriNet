            ...
            for (int i=0; i<m.maxStates; i++ ) {
                ...
                while (p!=null) {
                    ...
                    while(tr!=null) {
                        ...
                        statement = statement + Integer.toString(i);
                        statement += " ";
                        statement += event + " ";
                        statement = statement + Integer.toString(tr.next) + '\n';
                        tr=tr.nondet;
                    }
                    out.write(statement);
            ...
            for (int i=0; i<m.maxStates; i++ ) {
                ...
                while (p!=null) {
                    ...
                    while(tr!=null) {
                        ntrans[tr.next+1]++;
                        if (!newLabelFormat) {
                        	//Graphics g,int from, int to, String s, int n, boolean highlight, boolean dotext
